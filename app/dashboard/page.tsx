...
export default async function DashboardPage() {
  ...
  // for calculating stock percentage
  ...
  // for getting products created each week
  for (let i = 11; i >= 0; i--) {
    // for date labels
    ...
    const weekLabel = `${String(startOfWeek.getMonth() + 1).padStart(
      2,
      "0"
    )}/${String(startOfWeek.getDate() + 1).padStart(2, "0")}`;

    // for getting products
    const productsCreatedThisWeek = allProducts.filter((product) => {
    ...
    weeklyProductsData.push({
      week: weekLabel,
      products: productsCreatedThisWeek.length,
    });
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="mt-6 space-y-2">
              <div className="flex items-center justify-betwen text-sm text-gray-600">
